...
public:
  ...
  virtual ~Probe() { delete[] this->data; }
  ...
  // getter methods
  inline int getXRadius() const { return this->xRadius; }
  inline int getYRadius() const { return this->yRadius; }
  inline int getWidth() const { return this->width; }
  inline int getHeight() const { return this->height; }
  inline int getSize() const { return height * width; }
